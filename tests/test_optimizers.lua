--[[
    ...
    Note: run this file from the root dir of the repo.
          ...
          Example: th tests/test_optimizers.lua
]]
...
local optim_configs = {
    {expID = 'test_optimizer_adam', optimizer = 'adam', LR = 1e-3, LRdecay=0, weightDecay=0},
    {expID = 'test_optimizer_rmsprop', optimizer = 'rmsprop', LR = 1e-3, LRdecay=0, weightDecay=0},
    {expID = 'test_optimizer_adagrad', optimizer = 'adagrad', LR = 1e-3, LRdecay=0, weightDecay=0},
    {expID = 'test_optimizer_adadelta', optimizer = 'adadelta', LR = 1e-3, LRdecay=0, weightDecay=0},
    {expID = 'test_optimizer_sgd', optimizer = 'sgd', LR = 1e-3, momentum = 0.9, LRdecay=0, weightDecay=5e-4},
}
...
local fname = 'data/tests/test_optimizers.png'
